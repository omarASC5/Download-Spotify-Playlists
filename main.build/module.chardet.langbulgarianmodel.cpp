...
static PyObject *const_str_digest_4decebde7ba5a283134d9a81e122e500;
...
static void createModuleConstants(void) {
    const_tuple_d12d0d38133deb374cda3f2e99175f9b_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 217341 ], 1285);
    const_str_plain_Latin5_BulgarianCharToOrderMap = UNSTREAM_STRING_ASCII(&constant_bin[ 218626 ], 30, 1);
    const_str_plain_win1251BulgarianCharToOrderMap = UNSTREAM_STRING_ASCII(&constant_bin[ 218656 ], 30, 1);
    const_str_plain_BulgarianLangModel = UNSTREAM_STRING_ASCII(&constant_bin[ 218686 ], 18, 1);
    const_str_digest_f162f0e48afd9bd30970a540cb56b630 = UNSTREAM_STRING_ASCII(&constant_bin[ 218704 ], 35, 0);
    const_float_0_969392 = UNSTREAM_FLOAT(&constant_bin[ 218739 ]);
    const_str_plain_Bulgairan = UNSTREAM_STRING_ASCII(&constant_bin[ 218747 ], 9, 1);
    const_str_digest_4decebde7ba5a283134d9a81e122e500 = UNSTREAM_STRING_ASCII(&constant_bin[ 218756 ], 104, 0);
    const_str_plain_Bulgarian = UNSTREAM_STRING_ASCII(&constant_bin[ 4458 ], 9, 1);
    const_tuple_36b7ecdab49c9829602e64b169986871_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 218860 ], 20485);
    const_tuple_33562c24091b0ac3cbee9a55801943b1_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 239345 ], 1285);
...
static PyCodeObject *codeobj_a8b5f5de7ef43efdff8d92a0eb7340f0;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_4decebde7ba5a283134d9a81e122e500;
    codeobj_a8b5f5de7ef43efdff8d92a0eb7340f0 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_f162f0e48afd9bd30970a540cb56b630, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_chardet$langbulgarianmodel(PyObject *module) {
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a8b5f5de7ef43efdff8d92a0eb7340f0;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_4decebde7ba5a283134d9a81e122e500;
    ...
    // Frame without reuse.
    frame_a8b5f5de7ef43efdff8d92a0eb7340f0 = MAKE_MODULE_FRAME(codeobj_a8b5f5de7ef43efdff8d92a0eb7340f0, module_chardet$langbulgarianmodel);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_a8b5f5de7ef43efdff8d92a0eb7340f0);
    assert(Py_REFCNT(frame_a8b5f5de7ef43efdff8d92a0eb7340f0) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_4decebde7ba5a283134d9a81e122e500;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_a8b5f5de7ef43efdff8d92a0eb7340f0);
#endif
    popFrameStack();

    assertFrameObject(frame_a8b5f5de7ef43efdff8d92a0eb7340f0);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a8b5f5de7ef43efdff8d92a0eb7340f0, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a8b5f5de7ef43efdff8d92a0eb7340f0->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a8b5f5de7ef43efdff8d92a0eb7340f0, exception_lineno);
    }
