...
static PyObject *const_str_digest_1eaf8c13d3bd81358286e74e10b0fb8f;
...
static void createModuleConstants(void) {
    const_str_digest_7eaa2e05b6adbe04ee0f16efc52eb3a0 = UNSTREAM_STRING_ASCII(&constant_bin[ 292420 ], 32, 0);
    const_tuple_4f19fa3634bb485716df7f8f5e81152b_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 292452 ], 1285);
    const_float_0_984004 = UNSTREAM_FLOAT(&constant_bin[ 293737 ]);
    const_str_plain_HEBREW_LANG_MODEL = UNSTREAM_STRING_ASCII(&constant_bin[ 293745 ], 17, 1);
    const_str_plain_WIN1255_CHAR_TO_ORDER_MAP = UNSTREAM_STRING_ASCII(&constant_bin[ 293762 ], 25, 1);
    const_str_digest_1eaf8c13d3bd81358286e74e10b0fb8f = UNSTREAM_STRING_ASCII(&constant_bin[ 293787 ], 101, 0);
    const_tuple_96aea69e7c6c4b34b6c5234187423b87_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 293888 ], 20485);
...
static PyCodeObject *codeobj_e744c933ae6eaa2a5d2a6f9b08fa2fad;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_1eaf8c13d3bd81358286e74e10b0fb8f;
    codeobj_e744c933ae6eaa2a5d2a6f9b08fa2fad = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_7eaa2e05b6adbe04ee0f16efc52eb3a0, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_chardet$langhebrewmodel(PyObject *module) {
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_e744c933ae6eaa2a5d2a6f9b08fa2fad;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_1eaf8c13d3bd81358286e74e10b0fb8f;
        UPDATE_STRING_DICT0(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2);
    }
    // Frame without reuse.
    frame_e744c933ae6eaa2a5d2a6f9b08fa2fad = MAKE_MODULE_FRAME(codeobj_e744c933ae6eaa2a5d2a6f9b08fa2fad, module_chardet$langhebrewmodel);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_e744c933ae6eaa2a5d2a6f9b08fa2fad);
    assert(Py_REFCNT(frame_e744c933ae6eaa2a5d2a6f9b08fa2fad) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_1eaf8c13d3bd81358286e74e10b0fb8f;
        tmp_mvar_value_1 = GET_STRING_DICT_VALUE(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain___spec__);
    ...
    }
    {
        ...
        tmp_mvar_value_2 = GET_STRING_DICT_VALUE(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain___spec__);
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_e744c933ae6eaa2a5d2a6f9b08fa2fad);
#endif
    popFrameStack();

    assertFrameObject(frame_e744c933ae6eaa2a5d2a6f9b08fa2fad);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_e744c933ae6eaa2a5d2a6f9b08fa2fad, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_e744c933ae6eaa2a5d2a6f9b08fa2fad->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_e744c933ae6eaa2a5d2a6f9b08fa2fad, exception_lineno);
    }
    ...
    }
    {
        ...
        tmp_mvar_value_3 = GET_STRING_DICT_VALUE(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain_WIN1255_CHAR_TO_ORDER_MAP);

        if (unlikely(tmp_mvar_value_3 == NULL)) {
            tmp_mvar_value_3 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_WIN1255_CHAR_TO_ORDER_MAP);
        }
        ...
        tmp_mvar_value_4 = GET_STRING_DICT_VALUE(moduledict_chardet$langhebrewmodel, (Nuitka_StringObject *)const_str_plain_HEBREW_LANG_MODEL);

        if (unlikely(tmp_mvar_value_4 == NULL)) {
            tmp_mvar_value_4 = GET_STRING_DICT_VALUE(dict_builtin, (Nuitka_StringObject *)const_str_plain_HEBREW_LANG_MODEL);
        }
