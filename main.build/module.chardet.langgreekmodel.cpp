...
static PyObject *const_str_digest_613adecbbeb751fd984ba035d4f035d4;
...
static void createModuleConstants(void) {
    const_str_digest_613adecbbeb751fd984ba035d4f035d4 = UNSTREAM_STRING_ASCII(&constant_bin[ 269141 ], 100, 0);
    const_str_digest_63c8d65d52fb58b39520700ee4ec5234 = UNSTREAM_STRING_ASCII(&constant_bin[ 269241 ], 31, 0);
    const_str_digest_7718380faed4df7057283e0d1730db81 = UNSTREAM_STRING_ASCII(&constant_bin[ 269272 ], 12, 0);
    const_tuple_335b990c1cc0f8a22180626502e7512a_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 269284 ], 20485);
    const_str_plain_win1253_char_to_order_map = UNSTREAM_STRING_ASCII(&constant_bin[ 289769 ], 25, 1);
    const_tuple_f1a24a289c33e4ce8cd3d7c4beee6f6a_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 289794 ], 1285);
    const_tuple_314709394625831b834265dbf269a905_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 291079 ], 1285);
    const_str_plain_Latin7_char_to_order_map = UNSTREAM_STRING_ASCII(&constant_bin[ 292364 ], 24, 1);
    const_str_digest_7ca3e7632f1cccef85d1966320dcb68c = UNSTREAM_STRING_ASCII(&constant_bin[ 292388 ], 10, 0);
    const_str_plain_GreekLangModel = UNSTREAM_STRING_ASCII(&constant_bin[ 292398 ], 14, 1);
    const_float_0_982851 = UNSTREAM_FLOAT(&constant_bin[ 292412 ]);
...
static PyCodeObject *codeobj_d2e7ff5b57e64d05e0b8b9505b691d99;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_613adecbbeb751fd984ba035d4f035d4;
    codeobj_d2e7ff5b57e64d05e0b8b9505b691d99 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_63c8d65d52fb58b39520700ee4ec5234, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_chardet$langgreekmodel(PyObject *module) {
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_d2e7ff5b57e64d05e0b8b9505b691d99;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_613adecbbeb751fd984ba035d4f035d4;
        UPDATE_STRING_DICT0(moduledict_chardet$langgreekmodel, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2);
    }
    // Frame without reuse.
    frame_d2e7ff5b57e64d05e0b8b9505b691d99 = MAKE_MODULE_FRAME(codeobj_d2e7ff5b57e64d05e0b8b9505b691d99, module_chardet$langgreekmodel);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_d2e7ff5b57e64d05e0b8b9505b691d99);
    assert(Py_REFCNT(frame_d2e7ff5b57e64d05e0b8b9505b691d99) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_613adecbbeb751fd984ba035d4f035d4;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_d2e7ff5b57e64d05e0b8b9505b691d99);
#endif
    popFrameStack();

    assertFrameObject(frame_d2e7ff5b57e64d05e0b8b9505b691d99);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_d2e7ff5b57e64d05e0b8b9505b691d99, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_d2e7ff5b57e64d05e0b8b9505b691d99->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_d2e7ff5b57e64d05e0b8b9505b691d99, exception_lineno);
    }
