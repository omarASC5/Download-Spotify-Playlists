...
static PyObject *const_str_digest_da4185815bf292a71421050fec59cc0b;
...
static void createModuleConstants(void) {
    const_str_digest_9a8cb319aec60ead0975237a9305202f = UNSTREAM_STRING_ASCII(&constant_bin[ 336320 ], 33, 0);
    const_tuple_f2c470729e0f10e437bc567e306ce1de_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 336353 ], 1285);
    const_str_plain_Turkish = UNSTREAM_STRING_ASCII(&constant_bin[ 4580 ], 7, 1);
    const_str_digest_da4185815bf292a71421050fec59cc0b = UNSTREAM_STRING_ASCII(&constant_bin[ 337638 ], 102, 0);
    const_str_plain_Latin5_TurkishCharToOrderMap = UNSTREAM_STRING_ASCII(&constant_bin[ 337740 ], 28, 1);
    const_str_plain_TurkishLangModel = UNSTREAM_STRING_ASCII(&constant_bin[ 337768 ], 16, 1);
    const_tuple_439339857850830237fd4916bd45a217_tuple = PyMarshal_ReadObjectFromString((char *)&constant_bin[ 337784 ], 20485);
    const_float_0_97029 = UNSTREAM_FLOAT(&constant_bin[ 358269 ]);
    const_str_digest_e73b1cdb9cf9c90921f39f6162acd4c1 = UNSTREAM_STRING_ASCII(&constant_bin[ 358277 ], 10, 0);
...
static PyCodeObject *codeobj_a18e57fe0198db02b864991a5e07ff24;

static void createModuleCodeObjects(void) {
    module_filename_obj = const_str_digest_da4185815bf292a71421050fec59cc0b;
    codeobj_a18e57fe0198db02b864991a5e07ff24 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, const_str_digest_9a8cb319aec60ead0975237a9305202f, const_tuple_empty, 0, 0, 0);
}
...
PyObject *modulecode_chardet$langturkishmodel(PyObject *module) {
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a18e57fe0198db02b864991a5e07ff24;
    ...
    }
    {
        ...
        tmp_assign_source_2 = const_str_digest_da4185815bf292a71421050fec59cc0b;
        UPDATE_STRING_DICT0(moduledict_chardet$langturkishmodel, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2);
    }
    // Frame without reuse.
    frame_a18e57fe0198db02b864991a5e07ff24 = MAKE_MODULE_FRAME(codeobj_a18e57fe0198db02b864991a5e07ff24, module_chardet$langturkishmodel);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_a18e57fe0198db02b864991a5e07ff24);
    assert(Py_REFCNT(frame_a18e57fe0198db02b864991a5e07ff24) == 2);
    ...
    // Framed code:
    {
        ...
        tmp_assattr_name_1 = const_str_digest_da4185815bf292a71421050fec59cc0b;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_a18e57fe0198db02b864991a5e07ff24);
#endif
    popFrameStack();

    assertFrameObject(frame_a18e57fe0198db02b864991a5e07ff24);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a18e57fe0198db02b864991a5e07ff24, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a18e57fe0198db02b864991a5e07ff24->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a18e57fe0198db02b864991a5e07ff24, exception_lineno);
    }
