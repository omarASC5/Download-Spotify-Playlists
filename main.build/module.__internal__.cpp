...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_10_complex_call_helper_pos_keywords_star_list_star_dict(PyObject **python_pars);
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_10_complex_call_helper_pos_keywords_star_list_star_dict(PyObject **python_pars) {
    ...
    branch_yes_7:;
    {
        ...
        tmp_left_name_4 = const_str_digest_fdd1f239b4f3ffd6efcccf00e4a637e0;
        CHECK_OBJECT(par_called);
    ...
    branch_no_7:;
    {
        ...
        tmp_subscript_name_3 = const_int_pos_1;
        tmp_dictset_value = LOOKUP_SUBSCRIPT_CONST(tmp_expression_name_7, tmp_subscript_name_3, 1);
        if (tmp_dictset_value == NULL) {
            assert(ERROR_OCCURRED());
